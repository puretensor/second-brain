...
## Active Decisions & Pending Items

- **Google Cloud Startups:** Case #00263905. Applied Start tier, rejected as consultancy, appealed 2026-03-11. Awaiting response (overdue).
- **EUSS Settlement:** Pending, "final stages" per UKVI (9 Mar 2026). Overdue for escalation.
- **Harrods VAT Invoice:** Requested 2026-03-17 for GBP 1,477. Follow up by 2026-04-15.
- **Third Blackwell GPU:** Pending for fox-n0 (always-on 24/7). NVIDIA Inception pricing via Scan.
- **AWS Credits:** $5,200 active. Applied $10K via NVIDIA Inception. 10 Bedrock quota cases open.
